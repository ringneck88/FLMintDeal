import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-PQYKAAKU.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-CNSOVDEK.js";
import {
  LimitsModal
} from "./chunk-5C33L2XD.js";
import {
...
} from "./chunk-AEOOYY4M.js";
import {
  useTypedSelector
} from "./chunk-HVYEPU7U.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-7JMZG23H.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-ODAJ7C2Y.js";
import {
  index
} from "./chunk-XJHEOQA2.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-IG43Z2UG.js";
import {
  useConfig
} from "./chunk-4AX4HBYA.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-TZUVKJPR.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-DPBDHQG6.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-LWQO5R2C.js";
import {
  renderAdmin
} from "./chunk-TCO2NOT6.js";
import {
  useLicenseLimits
} from "./chunk-H5GOXVGJ.js";
import {
  Table,
  useTable
} from "./chunk-I64LVRM7.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-7PK46OTE.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-KFG3Y6EZ.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-4UTM4SYE.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-KPUIIQOZ.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-OLCK4Z7B.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ZAFPRXAX.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-MR45YWRZ.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-GEQV37IE.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-7PQP3TQT.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-7E27QLOS.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-RZXMB2JD.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-DFSVZ5TS.js");
          return {
...
//# sourceMappingURL=chunk-CEUQBTDS.js.map
