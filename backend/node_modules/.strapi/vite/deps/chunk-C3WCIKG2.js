import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-LXUXHUFS.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-VFCUD7TC.js";
import {
  index
} from "./chunk-452QLHXO.js";
import {
...
import {
  ...
  useGetReleasesQuery
} from "./chunk-GY5DB35N.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-FKGQJCVO.js";
import {
  LimitsModal
} from "./chunk-PXTRCEEP.js";
import {
...
} from "./chunk-URRXRE3O.js";
import {
  useTypedSelector
} from "./chunk-FE5G3JGM.js";
import {
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-NDELRDX3.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-JJOCGNWS.js";
import {
  buildValidParams,
...
import {
  renderAdmin
} from "./chunk-CESCGZ4P.js";
import {
  require_omit
} from "./chunk-W5ANTN7L.js";
import {
  require_cloneDeep
} from "./chunk-NLHOR4AS.js";
import {
  Form,
  Formik,
  useFormik
} from "./chunk-D466FHS6.js";
import {
  useLicenseLimits
} from "./chunk-QPT63BCE.js";
import {
  Table,
  useTable
} from "./chunk-2V2G3SBK.js";
import {
  useField,
  useForm
...
import {
  useAdminUsers
} from "./chunk-NDWWXYOX.js";
import {
  useTracking
} from "./chunk-DP3DDY6X.js";
import {
  useRBAC
} from "./chunk-6TDJNO6Z.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-AIGGLV3F.js");
    case "./translations/cs.json":
      return import("./cs.json-BQNTDKKY.js");
    case "./translations/de.json":
      return import("./de.json-G3WPCUN3.js");
    case "./translations/dk.json":
      return import("./dk.json-UJTKO3EV.js");
    case "./translations/en.json":
      return import("./en.json-NQAHPUAD.js");
    case "./translations/es.json":
      return import("./es.json-XPW3H2HI.js");
    case "./translations/fr.json":
      return import("./fr.json-UMY5KW73.js");
    case "./translations/id.json":
      return import("./id.json-CQNGFRAD.js");
    case "./translations/it.json":
      return import("./it.json-OJVYCRZO.js");
    case "./translations/ja.json":
      return import("./ja.json-47JD7PY4.js");
    case "./translations/ko.json":
      return import("./ko.json-IHGH7XC7.js");
    case "./translations/ms.json":
      return import("./ms.json-ERPOCLYA.js");
    case "./translations/nl.json":
      return import("./nl.json-HHONPYO3.js");
    case "./translations/pl.json":
      return import("./pl.json-FFPZCW6B.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-UWDEABLP.js");
    case "./translations/pt.json":
      return import("./pt.json-IC43BU37.js");
    case "./translations/ru.json":
      return import("./ru.json-4Q5ZJBID.js");
    case "./translations/sk.json":
      return import("./sk.json-QBPCCTV6.js");
    case "./translations/sv.json":
      return import("./sv.json-NV264MLS.js");
    case "./translations/th.json":
      return import("./th.json-XIGWYC5G.js");
    case "./translations/tr.json":
      return import("./tr.json-E73QHQOY.js");
    case "./translations/uk.json":
      return import("./uk.json-NQWXLJBH.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-BHPC5P5W.js");
    case "./translations/zh.json":
      return import("./zh.json-IZFV74VX.js");
    default:
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-ZJDB2VRM.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-RE2VUCH5.js").then((mod) => ({
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-4PJHDTYP.js");
    case "./translations/es.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-I54FSC47.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-GH5SAG4L.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-VE6CFYXQ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-BTBCLZSC.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-3HNWN56V.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-ZTOJSZPY.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-CIVOPX5Z.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-DQNESRC4.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-HQOIAM24.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-NJQQM5O3.js");
          return {
...
//# sourceMappingURL=chunk-C3WCIKG2.js.map
