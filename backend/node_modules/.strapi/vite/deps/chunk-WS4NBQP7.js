...
import {
  ...
  HOOKS
} from "./chunk-YCAWQGXI.js";
import {
  useNpsSurveySettings
} from "./chunk-6ZZNC6KH.js";
import {
  GuidedTourContext
} from "./chunk-CYUO7FL7.js";
import {
  require_pick
} from "./chunk-SWD7HKJO.js";
import {
  useEnterprise
} from "./chunk-4W3OO4IH.js";
import {
  getBasename
...
import {
  ...
  getEERoutes
} from "./chunk-NTF6YBGM.js";
import {
  Login
} from "./chunk-VODNMJFC.js";
import {
  MemoizedInputRenderer
} from "./chunk-ETJ6P3HJ.js";
import {
  Form
} from "./chunk-CZEWOCNY.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-KIW6APWY.js";
import {
  ConfigurationProvider
} from "./chunk-B3M52OQC.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-3ZONBOKZ.js";
import {
  require_baseRest
} from "./chunk-CNFWPOPO.js";
import {
  HistoryProvider
} from "./chunk-77LOGOXU.js";
import {
  errorsTrads
              ...
              children: [
                ...
                (0, import_jsx_runtime5.jsx)(Typography, {
                  ...
                  children: formatMessage({
                    ...
                    link: (0, import_jsx_runtime5.jsx)(Link, {
                      isExternal: true,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-QIEGQT2J.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-UEAJXIGQ.js");
        return {
      ...
      children: [
        ...
        (0, import_jsx_runtime7.jsx)(Flex, {
          ...
          children: (0, import_jsx_runtime7.jsx)(Box, {
            paddingTop: 4,
            children: (0, import_jsx_runtime7.jsx)(Link, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
      ...
      children: [
        ...
        (0, import_jsx_runtime8.jsx)(Flex, {
          ...
          children: (0, import_jsx_runtime8.jsx)(Box, {
            paddingTop: 4,
            children: (0, import_jsx_runtime8.jsx)(Link, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
      ...
      children: [
        ...
        (0, import_jsx_runtime9.jsx)(Flex, {
          ...
          children: (0, import_jsx_runtime9.jsx)(Box, {
            paddingTop: 4,
            children: (0, import_jsx_runtime9.jsx)(Link, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
      ...
      children: [
        ...
        (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime10.jsx)(Box, {
          ...
          children: (0, import_jsx_runtime10.jsx)(Flex, {
            justifyContent: "center",
            children: (0, import_jsx_runtime10.jsx)(Link, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
      ...
      children: [
        ...
        (0, import_jsx_runtime11.jsx)(Flex, {
          ...
          children: (0, import_jsx_runtime11.jsx)(Box, {
            paddingTop: 4,
            children: (0, import_jsx_runtime11.jsx)(Link, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-5CI6KDEC.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-OP2RQK4T.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-N2GHHWGT.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-U5NO7TRC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-763JYSJV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-QLZDZCZA.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-4MWDT3PQ.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-S2CYDWX4.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-WCWBON2M.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-PIK4MO35.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-4NMNTEHT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-UW4BIAUT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-5SCFPGPA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-2QNVWYGG.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-SXFTGROU.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-SNW5BYYV.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-XH5URSY2.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-XREMFCFX.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-TEYYA2FN.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-Y5YXU7WP.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-XFFGIMTK.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-OQIOA5FU.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-GE7K7XU4.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-NKKS5VQL.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-N6J4IZLY.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-KNNCV2IE.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-JGDUOP6N.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-MKTO45LM.js");
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-OG7Q4BAX.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-EJMKN3LJ.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-EJMKN3LJ.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-EF6YIKYO.js");
...
//# sourceMappingURL=chunk-WS4NBQP7.js.map
