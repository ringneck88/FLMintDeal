...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-TYZJWBBR.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-WFQZ53WR.js").then((mod) => ({
...
//# sourceMappingURL=router-7E27QLOS.js.map
