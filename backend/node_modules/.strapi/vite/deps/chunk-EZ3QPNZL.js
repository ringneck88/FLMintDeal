import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-EMUCV553.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-3DGPTBZ7.js";
import {
  LimitsModal
} from "./chunk-2CY5KYYM.js";
import {
...
} from "./chunk-H3FCIDRW.js";
import {
  useTypedSelector
} from "./chunk-5F4D4C6Z.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-OUEMYOXU.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-QCNXQ2DE.js";
import {
  index
} from "./chunk-ZJQ4UYYY.js";
import {
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-VNSHIJM4.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-FSCF6JPV.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-6LKHPO37.js";
import {
  renderAdmin
} from "./chunk-WS4NBQP7.js";
import {
  useLicenseLimits
} from "./chunk-FF3ATDAJ.js";
import {
  Table,
  useTable
} from "./chunk-PDOCLNCK.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-UDTSJ5N7.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-G2DQQQFR.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-IB6RIRYR.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-ZFTDILZC.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-K5HK4DPL.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
      ...
      (0, import_jsx_runtime26.jsx)(Popover.Content, {
        children: (0, import_jsx_runtime26.jsx)("ul", {
          children: releases.map(({ id, name: name2 }) => (0, import_jsx_runtime26.jsx)(Box, {
            padding: 3,
            tag: "li",
            children: (0, import_jsx_runtime26.jsx)(Link, {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-XY3YQRQP.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-UU3WDVAZ.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-LN6IRLYJ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-HALI2BQI.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-XD5DOG5P.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-BMEQNWJF.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-5KHEEJUF.js");
          return {
...
//# sourceMappingURL=chunk-EZ3QPNZL.js.map
