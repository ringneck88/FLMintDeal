...
var getInitialTourState = (tours2) => {
  return Object.keys(tours2).reduce((acc, tourName) => {
    const tourLength = Object.keys(tours2[tourName]).length;
    acc[tourName] = {
      currentStep: 0,
      length: tourLength,
      isCompleted: false
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/GuidedTour/Step.mjs
...
var tours = {
  contentTypeBuilder: createTour("contentTypeBuilder", [
    ...
    {
      name: "Components",
      content: (Step, { dispatch }) => (0, import_jsx_runtime3.jsxs)(Step.Root, {
        side: "right",
        sideOffset: 16,
        children: [
          (0, import_jsx_runtime3.jsx)(Step.Title, {
...
function createTour(tourName, steps) {
  const tour = steps.reduce((acc, step, index) => {
    ...
    acc[step.name] = ({ children }) => {
      return (0, import_jsx_runtime3.jsx)(GuidedTourTooltip, {
        tourName,
        step: index,
...
//# sourceMappingURL=chunk-GLF6YFV7.js.map
