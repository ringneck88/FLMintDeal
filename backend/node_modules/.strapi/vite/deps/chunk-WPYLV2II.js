...
import {
  LimitsModal
} from "./chunk-MQT5SZII.js";
import {
  useTypedSelector
} from "./chunk-QNXSK2O7.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-ICCZ56JJ.js";
import {
  getStageColorByHex
} from "./chunk-7KPRFSD6.js";
import {
...
import {
  ...
  useGetLocalesQuery
} from "./chunk-TMFY2NVJ.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-ZWCS4WFU.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-XXSLRZHM.js";
import {
  useConfig
} from "./chunk-WIKLOREY.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-MLCIGTDA.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-6EPDY76P.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-W5Q46ZDB.js";
import {
  renderAdmin
} from "./chunk-75AMSGKZ.js";
import {
  useLicenseLimits
} from "./chunk-F3MAHXSB.js";
import {
  Table,
  useTable
} from "./chunk-OQZXCP36.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-MJTDRMV5.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-S2QA7274.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-3T7CPUAW.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-JPSMV25O.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-RG4JAPD7.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-F7WBWLDS.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-ARFPWDQK.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-77WO4AVF.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-4V4CN76S.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-OM5SPXMD.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-CNSJKBCA.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-P2677FGC.js");
          return {
...
//# sourceMappingURL=chunk-WPYLV2II.js.map
